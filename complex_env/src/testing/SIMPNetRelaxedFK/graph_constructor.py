...
class GraphConstructor:
    def __init__(self, path, known_environment, start, goal, num_joints):
        '''
    ...
    def load_obstacle_embeddings(self):
        ...
        if self.known_environment:
            ...
            try:
                ...
                desktop1_center = obs_embeddings['Desktop I']['center']
                desktop1_size = obs_embeddings['Desktop I']['size']
                obstacle_embeddings.append(desktop1_center + desktop1_size)
                desktop2_center = obs_embeddings['Desktop II']['center']
                desktop2_size = obs_embeddings['Desktop II']['size']
                obstacle_embeddings.append(desktop2_center + desktop2_size)
                disassembly1_center = obs_embeddings['Disassembly_container_II']['center']
                disassembly1_size = obs_embeddings['Disassembly_container_II']['size']
                obstacle_embeddings.append(disassembly1_center + disassembly1_size)
    ...
    def construct_feature_matrix(self)->None:
        ...
        feature_matrix = torch.cat((node_embed_ang_sin, node_embed_ang_cos, goal_embed_ang_sin, 
