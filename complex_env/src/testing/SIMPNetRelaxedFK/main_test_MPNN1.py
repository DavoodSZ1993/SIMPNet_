...
def main(args):
    ...
    while i < args.num_sampled_start_end:
        ...
        while (not target_reached) and step < num_steps:
            ...
            if tree == 0:
                graph_const_fw = GraphConstructor(args.config_save_path, args.known_environment, start1, start2, args.num_joints)
                ...
                graph_const_bw = GraphConstructor(args.config_save_path, args.known_environment, start2, start1, args.num_joints)
                    ...
                    for j in range(0, len(path_free) - 1):
                        ...
                        if steer:
                            ...
                            while (not target_reached) and itr < num_steps:
                                itr = itr + 1
                                if tree == 0:
                                    graph_const_fw = GraphConstructor(args.config_save_path, args.known_environment, st, gl, args.num_joints)
                                    graph_fw, obs_embeddings = graph_const_fw.construct_graph()
                                    ...
                                    graph_const_bw = GraphConstructor(args.config_save_path, args.known_environment, gl, st, args.num_joints)
                                    graph_bw, obs_embeddings = graph_const_bw.construct_graph()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--trained_model_name', type=str, default='gaussian_trained_mainMPNN1.pt', help='The name of the trained model.')
    ...
    parser.add_argument('--planned_traj_path', type=str, default='/home/davood/catkin_ws/src/gnn4/src/testing/main_MPNN1/planned_paths', help='The directory for saving planned paths.')
