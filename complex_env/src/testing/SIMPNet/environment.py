...
class LoadEnvironment:
    ...
    def add_desks(self):
        ...
        desk3_pose.pose.position.x = -0.8
    ...
    def add_obstacles_unknown1(self):
        ...
        # Remove Obstacles
        self.scene.remove_world_object(desktop1_name)
        self.scene.remove_world_object(desktop2_name)
        self.scene.remove_world_object(disassembly1_name)
