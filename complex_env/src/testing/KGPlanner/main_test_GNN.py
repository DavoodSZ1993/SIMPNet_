            ...
            if feasible:
                ...
                while (not feasible) and (sp < 5) and (path !=0):
                    ...
                    if new_path != 0:
                        ...
                        print(f'replanning is feasible: {feasible}')
                        if feasible:
                            t_end = time.time()
                            planning_t = t_end - t_start
                            planning_times.append(planning_t)
                            ...
                            path = new_path
                            curr_time = time.time()
                            curr_planning_t = curr_time - t_start
...
if __name__ == "__main__":
    ...
    parser.add_argument('--planned_traj_path', type=str, default='/home/davood/catkin_ws/src/gnn4/src/testing/main_GNN/planned_paths', help='The directory for saving planned paths.')
