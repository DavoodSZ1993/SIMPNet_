...
if __name__ == "__main__":
    ...
    parser.add_argument('--trained_model_name', type=str, default='gaussian_trained_mainGNN.pt', help='The name of the trained model.')
    ...
    parser.add_argument('--num_start_end', type=int, default=100, help="The number of start - end configurations for each workspace.")
    ...
    parser.add_argument('--planned_traj_path', type=str, default='/home/davood/catkin_ws/src/GNN2/src/testing/main_GNN/planned_paths', help='The directory for saving planned paths.')
