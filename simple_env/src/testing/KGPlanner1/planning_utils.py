...
def load_normalization_info(gaussian_normalization=True):
    ...
    '''
    path = '/home/davood/catkin_ws/src/GNN2/src/Main_GNN_Paper'
    ...
    if gaussian_normalization:
        ...
        gauss_norm_mean = gaussian_normalization_info['all_features']['mean']
        gauss_norm_std = gaussian_normalization_info['all_features']['std']
        return gauss_norm_mean, gauss_norm_std
    else:
        return None
