...
if __name__ == "__main__":
    ...
    parser.add_argument('--planned_traj_path', type=str, default='/home/davood/catkin_ws/src/GNN2/src/testing/main_MPNN1/planned_paths', help='The directory for saving planned paths.')
